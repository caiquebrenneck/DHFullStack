...
public class Colecoes1 {
	...
	public static void main(String[] args) {
		...
		// Vou percorrer todos os elmentos da minhaLista
		...
		System.out.println(); //limpando o cash da memória
		...
		// pegar um elemento da minha lista através do indice
		...
		System.out.println("\nDespois de ordanada a minha lista, temos: ");
